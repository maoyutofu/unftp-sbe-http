...
where T: FromStr, T::Err: Display, D: de::Deserializer<'de> {
...
mod test {
    ...
    fn to_metadata_parse_error() {
        let response: serde_json::error::Result<Item> = serde_json::from_str(r#"{"name":"", "updated":"2020-09-01T12:13:14Z", "size":50}"#);
